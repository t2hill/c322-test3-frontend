...
const host_remote = "https://test3-latest-44wa.onrender.com";
...
async function signup() {
    ...
    let request = {
      ...
      try {
        let response = await fetch("http://localhost:8080/signup", request);
...
async function login() {    
    ...
    let request = {
      ...
      try {
        let response = await fetch("http://localhost:8080/signin", request);
        if(response.status == 200) {  
